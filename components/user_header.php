<header class="header">
       <section class="flex"> 
        <a href="home.php" class="logo"> <img src="../images/Logo.png" alt="" width="130px"></a>
        <nav class="navbar">
        ...
        <form action="search_product.php" method="post" class="search-from">
            ...
            <?php
               ...
               if($select_profile->rowCount() > 0) {
                ...
                <div class="flex-btn">
                    ...
                    <a href="components/user_logout.php" onclick="return confirm('log out from this website');" class="btn">logout</a>
                </div>
                 <?php } else{ ?>
