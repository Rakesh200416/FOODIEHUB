<?php 
     ...
     if(isset($_POST['place_order'])) {
        ...
        $email = $_POST['email'];
        $email = filter_var($number, FILTER_SANITIZE_STRING);
...
<head>
    ...
    <title>FoodieHub - order page</title>
            ...
            <div class="row">
                    ...
                    <div class="flex">
                        ...
                        <div class="box">
                            <div class="input-field">
                                ...
                                <input type="text" name="flat" required maxlength="50" placeholder="e.g #124 new home" class="input">
                            </div>
                            <div class="input-field">
                                <p>address line 2<span>*</span></p>
                                <input type="text" name="street" required maxlength="50" placeholder="e.g New building main block" class="input">
                            </div>
                            <div class="input-field">
                                <p>city name<span>*</span></p>
                                <input type="text" name="city" required maxlength="50" placeholder="e.g bengaluru" class="input">
                            </div>
                            <div class="input-field">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" name="pin" required maxlength="6" min="0" placeholder="e.g 573-231" class="input">
                            </div>
                         </div>
                    </div>
                ...
                <div class="summary">
                    ...
                    <div class="box-container">
                        ...
                        ?>
                        <div class="flex">
                            <img src="uploded_files/<?= $fetch_get['image']; ?>" alt="" class="image">
                            <div>
