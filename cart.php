<?php 
     ...
     if(isset($_POST['empty_cart'])) {
        ...
        if($verify_empty_item->rowCount() > 0) {
            ...
            $success_msg[] = 'all items deleted successfully';
...
<head>
    ...
    <title>FoodieHub -  My cart page</title>
                ...
                <?php 
                    ...
                    <?php if($fetch_products['stock'] > 9) { ?>
                        ...
                        <?php }elseif($fetch_products['stock'] == 0) { ?>
                            <span class="stock" style="color: red;">out ofstock</span>
                            <?php }else{ ?>
                                ...
                                <div class="content">
                                   ...
                                   <div class="flex-btn">
                                    ...
                                    <button type="submit" name="update_cart" class="fas fa-edit box "></button>
                                   </div>
                                   <div class="flex-btn">
            ...
            <?php if($grand_total != 0){   ?>
                <div class="cart-total">
                    ...
                    <button>
                        ...
                        <a href="checkout.php" class="btn">order all</a>
                    </button>
                </div>
            <?php } ?>
         </div>
