...
<head>
    ...
    <title>FoodieHub - shope page</title>
...
<div class="banner">
    <div class="detail">
        ...
        <span><a href="home.php">home</a><i class="bx bx-right-arrow-alt"></i>shop</span>
    </div>
</div>

<div class="products">
    <div class="heading">
        <h1>Our Healthy Products</h1>
    ...
    <div class="box-container">
        ...
        <form action="" method="post" class="box <?php if($fetch_products['stock'] == 0){echo "disabled";} ?>">
            <img src="uploded_files/<?= $fetch_products['image']; ?>" alt="">
