...
<head>
    ...
    <title>FoodieHub - View product page</title>
              ...
              <div class="box-container">
                ...
                <form action="" method="post" class="box">
                    ...
                    <?php if($fetch_products['image'] != ''){  ?>
                        <img src="../uploded_files/<?= $fetch_products['image']; ?>" alt="" class="image">
                    <?php } ?>
                    <div class="status" style="color: <?php if($fetch_products['status'] =='active'){echo "green";} else{echo "red";} ?>"><?= $fetch_products['status']; ?>
                </div>
                <div class="price">₹<?= $fetch_products['price']; ?>/-</div>
                <div class="content">
                    <img src="../images/shape-19.png" class="shap" alt="">
                    <div class="title"><?= $fetch_products['name']; ?></div>
                    <div class="flex-btn">
                        <a href="edit_product.php?id=<?= $fetch_products['id']; ?>" class="btn">edit</a>
                        <button type="submit" name="delete" class="btn" onclick="return confirm('delete this product');">delete</button>
                        <a href="read_product.php?post_id=<?= $fetch_products['id']; ?>" class="btn">read productt</a>
                    </div>
                </div>
                </form>
                <?php
