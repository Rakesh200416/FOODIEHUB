<?php
     ...
     if(isset($_POST['submit'])) {
        $select_sellers = $conn->prepare("SELECT * FROM `sellers` WHERE id = ? LIMIT 1");
        $select_sellers->execute([$seller_id]);
        $fetch_seller = $select_sellers->fetch(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>FoodieHub - seller profile update page</title>
