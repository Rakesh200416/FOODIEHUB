<?php
     ...
     if(isset($_POST['update_order'])) {
        ...
        $success_mag[] = 'order payment status updated';
...
<head>
    ...
    <title>FoodieHub - seller order page</title>
         ...
         <section class="order-container">
              ...
              <div class="box-container">
                <?php 
                    ...
                    ?>
                    <div class="box">
                        <div class="status" style="color: <?php if($fetch_order['status']=='in process') {echo "green";} else{echo "red";} ?>"><?= $fetch_order['status']; ?></div>
                        <div class="details" style="color: blue;">
                            ...
                            <p>user price : <span><?= $fetch_order['price']; ?></span></p>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="flex-btn">
                                ...
                                <input type="submit" name="delete_order" value="delete order" class="btn" onclick="confirm('delete this order');">
                            </div>
                        </form>
                    </div>
                    <?php
