...
if(isset($_POST['publish'])) {
    $id = unique_id(); // You need to define your unique_id() function
    ...
    if(isset($image) && $_FILES['image']['error'] == UPLOAD_ERR_OK) {
        ...
        $image = ''; // Set default if image not uploaded
    }
...
<head>
    ...
    <title>FoodieHub - admin add products page</title>
...
<body>
    <div class="main-container">
         ...
         <section class="dashboard">
              <div class="heading">
                <h1 style="color: whitesmoke;">add products</h1>
